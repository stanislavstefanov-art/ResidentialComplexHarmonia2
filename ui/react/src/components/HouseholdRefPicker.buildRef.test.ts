import { buildRef } from './HouseholdRefPicker';

// buildRef's output format is a cross-stack contract: the Angular
// HouseholdRefPickerComponent must produce byte-identical strings, and the
// backend uses this exact string as the `householdRef` query param on
// PUT/DELETE /households/item. A drift here silently breaks household
// edit/delete with no other test catching it.
describe('HouseholdRefPicker buildRef', () => {
